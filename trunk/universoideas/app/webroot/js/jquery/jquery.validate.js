...
$.extend($.validator, {
	...
	messages: {
		...
		time: "Formato de 12 horas HH:MM am|pm",
		time24: "Formato de 24 horas HH:MM",
	...
	methods: {
		...
		time24: function( value, element, param ) {
			return value == '' || value.match(/^([01][0-9]|2[0-3]):[0-5][0-9]$/);
		},
		
		time: function( value, element, param ) {
		    return value == '' || value.match(/^([0][1-9]|1[0-2]):[0-5][0-9] (am|pm|AM|PM)$/);
		},
