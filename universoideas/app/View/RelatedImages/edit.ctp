...
<?php echo $this->Form->create('RelatedImage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Related Image'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RelatedImage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('RelatedImage.id'))); ?></li>
