...
<div id="content_col_izq">
    <div class="channel_name">Ciencia</div>

    <?php include ("includes/published/galleries/galeria-ciencia.htm") ?>
    ...
    <?php include('includes/published/rios/rio-ciencia.htm'); ?>
    <div class="doble">
...
<div id="content_col_der">
    ...
    <div id="publicidadrcielo1" class="p5 tac"><div class="publicidad tal">ESPACIO PUBLICITARIO</div><a href="#"><img src="/img/publicidad/300x600.gif" width="250" alt="Publicidad" /></a></div>
</div>