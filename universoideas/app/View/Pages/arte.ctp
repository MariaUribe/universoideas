...
<div class="row">
    <div class="col-md-12">
        <h4 class="page-head-line channel_name">Arte</h4>
    </div>
</div>

<div class="row">
    <div class="col-md-9 col-sm-9">
        <?php include ("includes/published/galleries/galeria-arte.htm") ?>
    </div>
...
<div class="row mt15">
    <div class='col-md-9 col-sm-9 p0-10'>
        <?php include('includes/published/rios/rio-arte.htm'); ?>
    </div>
...
<!--div id="content_col_der">
    ...
    <div id="publicidadrcielo1" class="m10 p5 tac"><div class="publicidad tal">ESPACIO PUBLICITARIO</div><a href="#"><img src="/img/publicidad/300x600.gif" width="250" alt="Publicidad" /></a></div>
</div-->